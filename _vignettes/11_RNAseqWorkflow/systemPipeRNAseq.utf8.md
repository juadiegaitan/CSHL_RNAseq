...
Rscript -e "rmarkdown::render('systemPipeRNAseq.Rmd', clean=F)"; R CMD Stangle systemPipeRNAseq.Rmd; Rscript ../md2jekyll.R systemPipeRNAseq.knit.md 2
